...
namespace CarService
{
    class sharedFunction
    {
        ...
        public static DateTime ConvertToDate(string datestring)
        {
            ...
            try
            {
                formats = new string[] {"dMyy", "dd/MM/yyyy", "dd/MM/yy", "ddMMyyyy",
        ...
        public static string SQLDateString(DateTime date)
        {
            ...
            {
                return (int.Parse(date.ToString("yyyy")) - 543).ToString() + date.ToString("-MM-dd");
                //return (DateTime.Now.Year).ToString() + DateTime.Now.ToString("-MM-dd");
            }
            else
            {
        ...
        public static string ThaiDateString(DateTime date)
        {
            string stringCulture = System.Threading.Thread.CurrentThread.CurrentCulture.Name;
            if (stringCulture == "th-TH")
            {
                return DateTime.Now.ToString("yyyy-MM-dd");
            }
